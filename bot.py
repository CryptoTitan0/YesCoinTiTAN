...
╚══██╔══╝██║╚══██╔══╝██╔══██╗████╗  ██║
   ...
   ╚═╝   ╚═╝   ╚═╝   ╚═╝  ╚═╝╚═╝  ╚═══╝
          """)
    print(Fore.GREEN + Style.BRIGHT + "YesCoinTiTAN")
    print(Fore.GREEN + Style.BRIGHT + "Update Link: https://github.com/CryptoTitan0/YesCoinTiTAN")
    print(Fore.YELLOW + Style.BRIGHT + "Join Telegram Channel: https://t.me/Crypto_Titan0​")
    print(Fore.BLUE + Style.BRIGHT + "Subscribe Here https://youtube.com/@crypto_titan0​")
...
def process_account(token):
    ...
    if squad_info and squad_info['data']['isJoinSquad']:
        ...
        print(f"{Fore.YELLOW + Style.BRIGHT}\r[ Squad ] : Belum Join Squad. Joining Crypto Titan.", end="", flush=True)
        time.sleep(3)
        join_result = join_squad(token, "t.me/Crypto_Titan0")
        if join_result:
            print(f"{random.choice(available_colors) + Style.BRIGHT}\r[ Squad ] : Welcome Pemulung {nickname} - Crypto Titan!      ", flush=True)
        else:
            print(f"{random.choice(available_colors) + Style.BRIGHT}\r[ Squad ] : Failed to join Crypto Titan.", flush=True)
